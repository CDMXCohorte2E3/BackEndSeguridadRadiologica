//Llamado a base de datos de usuarios
...
}//function Toast Animación de inicio de sesión
...
function iniciarSesion() {
  ...
  let almacenLocal;
  let inputUsuario = { email : `${inputEmail2.value}`, password: `${inputContraseña2.value}` }
  ...
  fetch('http://localhost:8080/login/', {
    ...
    .then(data => {
      ...
      window.localStorage.setItem("tokenAdmin", JSON.stringify(almacenLocal))
